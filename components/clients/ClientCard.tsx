  ...
  return (
    ...
    >
      ...
      <View className="flex-row items-start gap-3 mb-2">
        <Avatar alt={client.fullName} className="h-10 w-10 bg-primary/20 items-center justify-center shrink-0">
          <AvatarFallback>
      ...
      <View className="flex-row items-end justify-between mt-2">
        <View>
          <Text className="text-muted-foreground text-[10px] font-bold uppercase tracking-wider mb-1">
            SALDO PENDIENTE
          </Text>
          <Text
        ...
        <View className="flex-row gap-2">
          <Pressable className="h-10 w-10 items-center justify-center bg-muted rounded-xl border border-border">
            <Phone size={18} className="text-secondary" />
          </Pressable>
          <Pressable className="h-10 w-10 items-center justify-center bg-green-500/10 rounded-xl border border-green-500/20">
            <MessageSquare size={18} className="text-green-600 dark:text-green-500" />
          </Pressable>
        </View>
      </View>
    </Pressable>
