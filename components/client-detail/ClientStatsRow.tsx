  ...
  return (
    <View className="flex-row gap-4 px-4 mb-6">
      ...
      <View className="flex-1 bg-card border border-border rounded-2xl p-4 items-center shadow-sm">
        <Clock size={24} color="#ef4444" className="mb-3" />
        <Text className="text-red-500 dark:text-red-400 text-xs font-bold uppercase tracking-wider mb-2">
          Historial
        </Text>
      ...
      {/* Puntualidad Card */}
      <View className="flex-1 bg-card border border-border rounded-2xl p-4 items-center shadow-sm">
        <TrendingUp size={24} color="#22c55e" className="mb-3" />
        <Text className="text-green-500 dark:text-green-400 text-xs font-bold uppercase tracking-wider mb-2">
          Puntualidad
        </Text>
        <Text className="text-3xl font-extrabold text-foreground mb-1">
